...
public class ArmConstraintsSolver {
  ...
  public static double calculateMaximumExtensionLength(double angleRadians) {
    ...
    maximumLengths.add(
        calculateVertical(
            Constants.Arm.Constraints.MIN_HEIGHT - Constants.Physical.ARM_SHOULDER_HEIGHT,
            angleRadians));
    maximumLengths.add(
        calculateVertical(
            Constants.Arm.Constraints.MAX_HEIGHT - Constants.Physical.ARM_SHOULDER_HEIGHT,
            angleRadians));
  ...
  public static boolean isWithinRuleZone(ArmPosition position) {
    return position.extensionLengthMeters
        < calculateMaximumExtensionLength(position.rotationAngleRadians);
  }
}
