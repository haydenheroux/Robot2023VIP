...
public class GyroIOPigeon2 implements GyroIO {
    ...
    public void setRollAngle(double rollAngleRadians) {
        offset = new Rotation3d(values.rollAngleRadians + rollAngleRadians, values.pitchAngleRadians, values.yawAngleRadians);
    }

    @Override
    public void setPitchAngle(double pitchAngleRadians) {
        offset = new Rotation3d(values.rollAngleRadians, values.pitchAngleRadians + pitchAngleRadians, values.yawAngleRadians);
    }

    @Override
    public void setYawAngle(double yawAngleRadians) {
        offset = new Rotation3d(values.rollAngleRadians, values.pitchAngleRadians, values.yawAngleRadians + yawAngleRadians);
    }
