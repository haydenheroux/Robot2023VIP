...
public class Swerve extends SubsystemBase implements TelemetryOutputter {
  ...
  public void initializeDashboard() {
    ...
    ShuffleboardLayout module0Layout = tab.getLayout("[0] " + modules[0].config.name, BuiltInLayouts.kList);
    ...
    ShuffleboardLayout module1Layout = tab.getLayout("[1] " + modules[1].config.name, BuiltInLayouts.kList);
    ...
    ShuffleboardLayout module2Layout = tab.getLayout("[2] " + modules[2].config.name, BuiltInLayouts.kList);
    ...
    ShuffleboardLayout module3Layout = tab.getLayout("[3] " + modules[3].config.name, BuiltInLayouts.kList);
